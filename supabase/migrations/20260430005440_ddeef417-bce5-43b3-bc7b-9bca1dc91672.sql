...
BEGIN
  ...
  -- Resolve project_type (NOT NULL em projects). Tenta:
  -- 1) project_type legado do deal
  -- 2) primeiro slug de project_type_v2 que case com o enum
  -- 3) fallback 'sistema_personalizado'
