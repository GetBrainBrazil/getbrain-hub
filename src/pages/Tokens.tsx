  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-center justify-center gap-6 px-6 py-24 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl font-semibold tracking-tight">Módulo Tokens de IA</h1>
        <p className="text-sm text-muted-foreground">
          Em desenvolvimento. Consumo de tokens por projeto, bolsão mensal por
          contrato de manutenção e alertas de orçamento aparecerão aqui.
        </p>
      </div>
