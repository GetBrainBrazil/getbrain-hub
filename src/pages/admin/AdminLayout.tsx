...
import { getAdminExitRoute } from "@/components/RouteTracker";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start gap-3">
        <Button variant="ghost" size="icon" onClick={() => navigate(getAdminExitRoute(), { replace: true })} className="h-10 w-10 -ml-2 mt-1" aria-label="Voltar">
