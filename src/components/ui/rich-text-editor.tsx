  ...
  function RichTextEditor(
    ...
    return (
      <div className="relative">
        ...
        <div
          className={cn(
            "absolute left-0 bottom-full z-20 mb-1 inline-flex w-max max-w-full items-center gap-0.5 overflow-x-auto whitespace-nowrap rounded-md border border-border bg-popover/95 px-1 py-0.5 shadow-md backdrop-blur-sm transition-all duration-150 [scrollbar-width:thin]",
            focused
